...
CLASS_CENTERS: Final[dict[str, np.ndarray]] = {
    "BENIGN": np.array(
        [
            1500.0, 12.0, 14.0, 1800.0, 5000.0, 150.0, 350.0, 4800.0, 18.0,
            220.0, 320.0, 110.0, 220.0, 250.0, 90.0, 0.5, 1.2, 0.1, 1.0, 8.0, 280.0,
        ]
    ),
    "DDoS": np.array(
        [
            32.0, 4.0, 0.5, 240.0, 12.0, 60.0, 8.0, 8500.0, 135.0, 8.0,
            18.0, 6.0, 22.0, 60.0, 22.0, 0.1, 4.5, 0.0, 4.5, 5.0, 64.0,
        ]
    ),
    "BruteForce": np.array(
        [
            55.0, 3.0, 0.5, 140.0, 8.0, 46.0, 10.0, 2700.0, 55.0, 22.0,
            32.0, 11.0, 33.0, 46.0, 18.0, 0.1, 3.2, 0.0, 3.2, 3.5, 50.0,
        ]
    ),
    "PortScan": np.array(
        [
            820.0, 9.0, 7.0, 1320.0, 2840.0, 146.0, 405.0, 5100.0, 19.5, 105.0,
            155.0, 200.0, 155.0, 275.0, 130.0, 0.2, 1.0, 0.0, 2.0, 7.0, 275.0,
        ]
    ),
}
...
def _cli() -> None:
    ...
    parser.add_argument(
        "--output", type=Path, required=True, help="Output CSV path."
    )
